...
public final class RawTransaction {
    ...
    public RawTransaction(AccountAddress sender, @com.novi.serde.Unsigned Long sequence_number,
                          TransactionPayload payload,
                          @com.novi.serde.Unsigned Long max_gas_amount,
                          @com.novi.serde.Unsigned Long gas_unit_price,
                          //String gas_token_code,
                          @com.novi.serde.Unsigned Long expiration_timestamp_secs,
                          ChainId chain_id) {
